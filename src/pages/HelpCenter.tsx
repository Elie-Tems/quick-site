...
**מועד החיוב:**
- החיוב החודשי מתבצע **ב-1 בכל חודש** (הוראת קבע קבועה).
- **החודש הראשון** משולם במלואו בעת פרסום האתר, והאתר עולה מיד. החיוב הבא יהיה ב-1 בחודש - כך שתמיד מקבלים חודש שלם ולא נגבה חלקי.
...
**תוספות (כמו ביקורות Google):**
- תוסף שנוסף באמצע החודש מחויב באופן יחסי על הימים עד ה-1 הבא, ומ-1 בחודש הוא מצטרף כשורה נפרדת ל**חשבונית החודשית המאוחדת** (מנוי + תוספות יחד).
