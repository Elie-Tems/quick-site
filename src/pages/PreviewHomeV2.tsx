 ...
 * b-roll - heavily blurred + dark-green tinted so it reads as organic motion, not
 * a specific clip. Swap it for a real brand clip before going live.
 */
...
const AuroraBg = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Ambient placeholder video - blurred, tinted, unrecognizable */}
    <video
      className="absolute inset-0 w-full h-full object-cover opacity-[0.18] blur-[2px] scale-110"
    ...
    <motion.div
      ...
      style={{ background: "radial-gradient(circle, hsl(152 60% 45% / 0.35), transparent 70%)" }}
      animate={{ x: [0, -60, 0], y: [0, 40, 0], scale: [1, 1.15, 1] }}
      transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
    />
    <motion.div
      className="absolute top-1/3 left-[-15%] w-[40rem] h-[40rem] rounded-full blur-[140px]"
      style={{ background: "radial-gradient(circle, hsl(170 70% 40% / 0.28), transparent 70%)" }}
      animate={{ x: [0, 70, 0], y: [0, -50, 0], scale: [1, 1.2, 1] }}
      transition={{ duration: 22, repeat: Infinity, ease: "easeInOut" }}
    />
    <motion.div
      className="absolute bottom-[-20%] right-1/4 w-[38rem] h-[38rem] rounded-full blur-[150px]"
      style={{ background: "radial-gradient(circle, hsl(90 65% 45% / 0.20), transparent 70%)" }}
...
// ---- Phone reel (reads as a screen recording of the store) -----------------
const PhoneReel = () => {
      ...
      <div className="relative w-[270px] md:w-[310px] h-[550px] md:h-[630px] rounded-[3rem] bg-gradient-to-b from-zinc-800 to-zinc-900 p-2.5 shadow-2xl">
        ...
        <div className="w-full h-full rounded-[2.4rem] bg-black overflow-hidden relative">
          ...
          <div className="w-full h-full bg-gradient-to-b from-zinc-950 to-black p-3 pt-10 flex flex-col">
            ...
            {/* Cross-fading hero banner = "video" motion */}
    ...
    {[0, 1].map((k) => (
      ...
      >
        {CATEGORIES.map((c, idx) => (
          <span key={idx} className="flex items-center gap-6 text-2xl md:text-3xl font-display font-bold text-white/25 whitespace-nowrap">
            {c}
    ...
    <div className="container relative z-10 max-w-5xl mx-auto">
      <Reveal className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6">
          ...
          <span className="text-sm text-white/70">רואים איך זה נראה</span>
        </div>
        <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-4">צפו איך זה קורה</h2>
        <p className="text-lg md:text-xl text-white/60">מהרעיון לחנות פעילה - בלי קוד, בלי מעצב, בלי כאב ראש</p>
      </Reveal>
      <Reveal delay={0.1}>
        <div className="relative group rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl">
          ...
          {/* Browser chrome */}
          <div className="relative bg-zinc-900/90 backdrop-blur">
            <div className="flex items-center gap-2 px-4 h-11 border-b border-white/10">
              ...
              <div className="mx-auto text-xs text-white/40 bg-black/40 rounded-md px-4 py-1">siango.app/my-store</div>
            </div>
            <video
...
const PreviewHomeV2 = () => {
  ...
  return (
    <div className="theme-refined bg-[#0a0a0a] text-white min-h-screen overflow-x-hidden">
      <Header />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-right order-1">
              ...
              >
                ...
                <span className="text-sm text-white/80">בונים חנות אונליין - בלי ידע טכני</span>
              </motion.div>
              ...
              >
                <span className="block bg-gradient-to-l from-white via-white to-white/70 bg-clip-text text-transparent">
                  אתר מכירות
                </span>
                <span className="relative inline-flex overflow-hidden h-[1.15em] items-center">
                  <AnimatePresence mode="popLayout">
                    <motion.span
                      ...
                      className="bg-gradient-to-l from-primary via-emerald-400 to-lime-300 bg-clip-text text-transparent"
                    >
                      {ROTATING[rot]}
                    </motion.span>
                  </AnimatePresence>
                </span>
                <span className="block text-white/90">תוך 5 דקות</span>
              </motion.h1>

              <motion.p
                initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
                className="text-xl md:text-2xl text-white/70 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed"
              >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/5 border border-white/10 mb-9"
              >
                <span className="text-2xl md:text-3xl font-bold text-white">69 ש"ח<span className="text-base font-normal text-white/50"> לחודש + מע"מ</span></span>
              ...
              >
                ...
                <a href="#demo" className="inline-flex items-center gap-2 px-7 py-4 rounded-2xl bg-white/5 border border-white/15 text-white font-semibold hover:bg-white/10 transition-colors">
                  <Play className="w-4 h-4 text-primary" />
                  צפו בדמו
                </a>
              </motion.div>
              ...
              <motion.div
                ...
                className="flex items-center gap-6 mt-7 justify-center lg:justify-start text-white/60"
              >
      ...
      {/* MARQUEE */}
      <section className="relative py-10 border-y border-white/5 bg-black/30 space-y-4">
        <Marquee />
        <Marquee reverse />
      </section>
      ...
      <section className="relative py-24 md:py-32 px-4">
        <div className="container relative z-10 max-w-6xl mx-auto">
          <Reveal className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-4">איך זה עובד?</h2>
            <p className="text-lg md:text-xl text-white/60">כמה צעדים פשוטים והאתר שלכם באוויר</p>
          </Reveal>
          <div className="grid md:grid-cols-3 gap-6">
            {STEPS.map((s, idx) => (
              <Reveal key={s.n} delay={idx * 0.12}>
                <div className="group relative h-full rounded-3xl bg-white/[0.03] border border-white/10 p-8 overflow-hidden hover:border-primary/40 transition-colors">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <span className="text-5xl font-display font-bold text-white/10">{s.n}</span>
                    </div>
      ...
      {/* AUDIENCES */}
      <section className="relative py-24 md:py-32 px-4 bg-black/30 border-y border-white/5">
        <div className="container relative z-10 max-w-6xl mx-auto">
          <Reveal className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6">
              <Sparkles className="w-4 h-4 text-primary" />
              <span className="text-sm text-white/70">לכל סוגי העסקים</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-4">למי זה מתאים?</h2>
            <p className="text-lg md:text-xl text-white/60">לכל מי שרוצה להתחיל למכור אונליין</p>
          </Reveal>
          ...
          <p className="text-center text-white/50 mt-10">
            <span className="text-white font-semibold">ועוד עשרות</span> תחומים נוספים...
          </p>
        </div>
      </section>
        ...
        <div className="container relative z-10 max-w-5xl mx-auto">
          <Reveal className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6">
              ...
              <span className="text-sm text-white/70">יתרונות הפלטפורמה</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-4">מה מקבלים?</h2>
            <p className="text-lg md:text-xl text-white/60">כל מה שצריך כדי להתחיל למכור אונליין</p>
          </Reveal>
      ...
      <section className="relative py-28 px-4 overflow-hidden">
        ...
        <Reveal className="relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
            מוכנים? האתר שלכם<br />באוויר תוך <span className="bg-gradient-to-l from-primary via-emerald-400 to-lime-300 bg-clip-text text-transparent">5 דקות</span>
          </h2>
          <Link
            to="/register"
          ...
          <p className="text-white/50 mt-4">5 דקות · ללא ידע טכני · ללא התחייבות</p>
        </Reveal>
      </section>
