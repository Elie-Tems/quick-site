...
export const storeLayouts: Record<StoreLayoutId, StoreLayout> = {
  classic: {
    id: 'classic',
    name: 'תמונה מרכזית',
    description: 'תמונת גיבור על כל רוחב הדף, טקסט מרכזי עם שכבת צבע. קלאסי ומוכר.',
  ...
  service: {
    id: 'service',
    name: 'פיצול — טקסט ותמונה',
    description: 'חצי מסך בצבע עסקי עם טקסט, חצי עם תמונה. בולט ומקצועי.',
  ...
  property: {
    id: 'property',
    name: 'גרדיאנט גדול',
    description: 'Hero גדול עם גרדיאנט צבעוני, כל הטקסט מרכזי ובולט.',
  ...
  market: {
    id: 'market',
    name: 'שוק — פיצול',
    description: 'פריסת פיצול עם קטגוריות בולטות. מתאים למגוון רחב של מוצרים.',
  ...
  boutique: {
    id: 'boutique',
    name: 'בוטיק — תמונה מלאה',
    description: 'תמונה מרהיבה על כל המסך עם שכבת צבע עדינה. אלגנטי ומינימליסטי.',
  ...
  'beauty-spa': {
    id: 'beauty-spa',
    name: 'ספא — גרדיאנט',
    description: 'Hero גרדיאנט רך עם כותרת מרכזית גדולה. מפנק ועדין.',
  ...
  'home-pro': {
    id: 'home-pro',
    name: 'מקצועי — פיצול',
    description: 'חצי רקע עסקי עם טקסט מקצועי, חצי תמונה. ישיר ואמין.',
  ...
  charity: {
    id: 'charity',
    name: 'עמותה — תמונה מלאה',
    description: 'תמונה רגשית עם שכבת כהה וטקסט מרכזי. מרגש ומניע לפעולה.',
  ...
  restaurant: {
    id: 'restaurant',
    name: 'מסעדה — תמונה',
    description: 'תמונה אווירתית על כל הדף, טקסט בצד. מתאים לאוכל ואירוח.',
