...
const seoBlocks = [
  {
    ...
    content:
      "רוצים למכור אונליין בלי להסתבך? אתר מכירתי נותן לעסק הקטן חלון ראווה שפתוח כל הזמן: מקום שלקוחות נכנסים אליו, מזמינים ומשלמים, בלי להיות תלויים רק ברשתות.",
  ...
  },
  {
    ...
    content:
      "מעלים מוצרים, קובעים מחירים, ומתחילים לקבל הזמנות. תוך כמה דקות יש לכם חנות שעובדת, בלי מתכנת ובלי תקציב פיתוח.",
  ...
  },
  {
    ...
    content:
      "אתר איטי מבריח לקוחות. האתרים שלנו נטענים מהר, גם בנייד, כדי שהמבקר יישאר, יגלוש ויקנה (וגם גוגל אוהב את זה).",
