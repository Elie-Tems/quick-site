...
const DashboardHome = ({
  ...
  const typeLabels: Record<string, { orders: string; sales: string; products: string; customers: string; addProducts: string }> = {
    ...
    kolel:      { orders: t("dash.home.type.kolel.orders"),    sales: t("dash.home.type.kolel.sales"),    products: t("dash.home.type.kolel.products"),    customers: t("dash.home.type.kolel.customers"),    addProducts: t("dash.home.type.kolel.add_products") },
