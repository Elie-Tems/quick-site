...
const products: {
...
}[] = [
  {
    ...
    pitch: "כרטיס לקוח מלא עם היסטוריית קניות, סגמנטים, תגיות - וריטרגטינג ישיר בוואטסאפ.",
    bullets: ["כרטיס לקוח עם כל ההיסטוריה", "סגמנטים חכמים ותגיות", "שליחת הטבה בוואטסאפ"], category: "לקוחות", show: true, badge: "פופולרי",
  },
  {
