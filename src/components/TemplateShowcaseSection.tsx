  ...
  const templates = [
    ...
    },
    {
      ...
      style: {
        ...
        productsBg: "bg-[#b05470]",
        productsGap: "gap-2 p-3",
        imageRadius: "rounded-2xl",
        imageWrap: "bg-white rounded-2xl p-1",
        priceBg: "pt-1",
        priceLabel: "text-[9px] text-white/60 tracking-wide",
        priceValue: "text-[11px] font-semibold text-white",
        badge: "bg-white text-[#b05470] text-[8px] rounded-full px-2 py-0.5 font-bold",
    ...
    },
    {
      ...
      style: {
        ...
        productsBg: "bg-[#2d5a4a]",
        productsGap: "gap-2.5 p-3",
        imageRadius: "rounded-xl",
        imageWrap: "bg-[#f4f1eb] rounded-xl p-0.5",
        priceBg: "pt-1",
        priceLabel: "text-[9px] text-white/50 tracking-wide",
        priceValue: "text-[11px] font-semibold text-white",
        badge: "bg-white text-[#2d5a4a] text-[8px] rounded-full px-2 py-0.5 font-bold",
              ...
              <div className={`grid grid-cols-3 ${template.style.productsBg} ${template.style.productsGap}`}>
                {template.products.map((img, j) => (
                  <div key={j} className={`relative ${template.style.imageWrap}`}>
                    ...
                    {/* Fashion: person silhouette with product on body */}
                    {template.id === 1 ? (
                      <div className="relative w-full aspect-square bg-zinc-50 overflow-hidden">
                        <svg viewBox="0 0 60 60" className="absolute inset-0 w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <ellipse cx="30" cy="9" rx="6.5" ry="7" fill="#e2ddd9"/>
                          <path d="M18 17 Q30 13 42 17 L44 42 Q30 46 16 42 Z" fill="#d6d0cb"/>
                          <path d="M18 17 L10 38" stroke="#d6d0cb" strokeWidth="5.5" strokeLinecap="round"/>
                          <path d="M42 17 L50 38" stroke="#d6d0cb" strokeWidth="5.5" strokeLinecap="round"/>
                          <path d="M23 42 L20 62 M37 42 L40 62" stroke="#d6d0cb" strokeWidth="6.5" strokeLinecap="round"/>
                        </svg>
                        <div className="absolute inset-[18%] top-[22%] bottom-[28%]">
                          <img src={img} alt="" className="w-full h-full object-cover" />
                        </div>
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white/80 to-transparent px-1.5 pt-4 pb-1">
