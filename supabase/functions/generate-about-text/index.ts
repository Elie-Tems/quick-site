...
serve(async (req) => {
  ...
  try {
    ...
    if (!(await consumeRateLimit(rl, `abouttext:user:${userId}`, 30, 3600))) {
...
- אורך אידיאלי: 5-8 משפטים (150-300 מילים) — תאר את העסק, הצוות/המייסדים, הניסיון, הערכים, ומה מייחד אותם.
